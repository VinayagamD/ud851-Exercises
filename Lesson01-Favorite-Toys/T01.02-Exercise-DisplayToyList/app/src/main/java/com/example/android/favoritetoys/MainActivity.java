...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StringBuilder namesBuilder =  new StringBuilder(toyNames[0]);
        for(int i = 1; i < toyNames.length ; i++){
            if(i < toyNames.length-1)
            namesBuilder.append("\n");
            namesBuilder.append(toyNames[i]);    
        }
        mToysListTextView.setText(namesBuilder.toString());
